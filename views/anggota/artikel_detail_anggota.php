...
if (!$artikel) {
    header('Location: index_anggota.php?page=artikel_anggota');
    exit;
}
...
include '../../includes/anggota/header_artikel_detail_anggota.php';
?>

<section class="breadcrumb-section">
  <div class="container">
    <nav class="breadcrumb">
      <a href="index_anggota.php?page=home_anggota">Home</a>
      <span class="separator">/</span>
      <a href="index_anggota.php?page=artikel_anggota">Artikel</a>
      <span class="separator">/</span>
  ...
  <div class="container">
    <article class="article-detail">
      ...
      <div class="article-footer">
        <a href="index_anggota.php?page=artikel_anggota" class="btn-back">← Kembali ke Artikel</a>
    ...
    <section class="related-articles">
      ...
      <div class="related-grid">
        ...
        <a href="index_anggota.php?page=artikel_detail_anggota&id=<?php echo $related['id']; ?>" class="related-card">
...
<?php include '../../includes/anggota/footer_artikel_detail_anggota.php'; ?>
