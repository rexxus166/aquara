<?php
// (Koneksi $conn sudah ada dari index_anggota.php)
$activeMenu = 'forum';
...
if (isset($_GET['action']) && $_GET['action'] == 'delete_topic' && isset($_GET['id'])) {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Topik berhasil dihapus!'); window.location.href='index_anggota.php?page=forum_anggota';</script>";
    } else {
...
<head>
    ...
    <title>Forum Anggota - AQUARA</title>
    ...
    <style>
        ...
        .btn-like.liked { color: #3f8686; font-weight: 600; background: rgba(63, 134, 134, 0.1); }
...
<main class="forum-container">
    <div class="forum-header-section">
        ...
        <a href="index_anggota.php?page=tambah_topik" class="btn-buat-topik">
            <i class="bi bi-plus-lg"></i> Buat Topik Baru
        </a>
    </div>

    <form class="search-bar" method="GET" action="index_anggota.php">
        <input type="hidden" name="page" value="forum_anggota">
            ...
            <?php foreach ($topics as $topic): ?>
                <article class="post-card">
                    <div class="post-header">
                        ...
                        <div class="author-info">
                            <h4>
                                ...
                                <span class="author-role"><?php echo htmlspecialchars($topic['role_name'] ?? 'Anggota'); ?></span>
                            </h4>
                        </div>
                        ...
                        <?php if ($topic['user_id'] == $user_id_login): ?>
                            <div class="post-options" style="margin-left: auto; display: flex; align-items: center; gap: 10px;">
                                ...
                                <a href="index_anggota.php?page=forum_anggota&action=delete_topic&id=<?= $topic['id']; ?>" 
                    ...
                    <div class="post-content">
                        <h3>
                            <a href="index_anggota.php?page=forum_detail&id=<?php echo $topic['id']; ?>">
                    ...
                    <div class="post-actions">
                        <a href="index_anggota.php?page=forum_detail&id=<?php echo $topic['id']; ?>" class="action-btn">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.btn-share').forEach(btn => {
        btn.addEventListener('click', function() {
            const url = window.location.origin + window.location.pathname.replace('index_anggota.php', '') + 'index_anggota.php?page=forum_detail&id=' + this.dataset.id;
            if (navigator.share) {
