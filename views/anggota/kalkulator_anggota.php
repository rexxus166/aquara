...
// --- 2. AMBIL DATA RIWAYAT (UNTUK DITAMPILKAN) ---
$user_id = $_SESSION['user_id'];
...
<head>
    ...
    <style>
        /* CSS Tambahan untuk Tabel Riwayat */
...
<?php include '../../includes/anggota/header_kalkulator_anggota.php'; ?>
...
<section id="section-kalkulator" class="kalkulator-section">
    <div class="container">
        <div class="kalkulator-intro">
            <div class="intro-icon"><i class="bi bi-calculator-fill"></i></div>
                ...
                <div class="form-card">
                    ...
                    <form id="kalkulatorForm" class="kalkulator-form">
                        <div class="form-group">
                            <label for="luasKolam"><i class="bi bi-rulers"></i> Luas Kolam (m²)</label>
                            <input type="number" id="luasKolam" name="luasKolam" placeholder="Contoh: 100">
                        </div>
                        <div class="form-group">
                            <label for="jenisIkan"><i class="bi bi-water"></i> Jenis Ikan</label>
                        ...
                        <div class="form-group">
                            <label for="jumlahBibit"><i class="bi bi-egg"></i> Jumlah Bibit (Ekor)</label>
                            <input type="number" id="jumlahBibit" name="jumlahBibit" placeholder="Contoh: 5000">
                        </div>
                        <div class="form-group">
                            <label for="hargaBibit"><i class="bi bi-cash-coin"></i> Harga Bibit (Rp)</label>
                            <input type="number" id="hargaBibit" name="hargaBibit" placeholder="Contoh: 500">
                        </div>
                        <div class="form-group">
                            <label for="hargaPakan"><i class="bi bi-basket"></i> Harga Pakan (Rp)</label>
                            <input type="number" id="hargaPakan" name="hargaPakan" placeholder="Contoh: 8000">
                        </div>
                        <div class="form-group">
                            <label for="targetPanen"><i class="bi bi-calendar-check"></i> Durasi (Bulan)</label>
        ...
        <div class="riwayat-section">
            <h3 class="riwayat-title"><i class="bi bi-clock-history"></i> Riwayat Perhitungan</h3>
                ...
                <table class="table-riwayat">
                    ...
                    <tbody>
                        <?php foreach ($history_list as $item): 
                            ...
                            // Siapkan data untuk modal (encode base64 biar aman)
...
<?php include '../../includes/anggota/footer_kalkulator_anggota.php'; ?>
...
// Modifikasi fungsi simpan agar reload halaman setelah sukses
// Override fungsi simpanHasil yang ada di file eksternal (kalkulator_pakar.js)
// Ini agar setelah simpan, riwayat langsung muncul (karena perlu refresh PHP untuk ambil data baru)
const originalSimpan = window.simpanHasil;
window.simpanHasil = function() {
    // Panggil logika simpan asli (AJAX)
    // Tapi kita perlu memodifikasi sedikit di JS eksternal atau kita override fetch-nya.
    // Agar lebih mudah, kita edit sedikit JS eksternal atau kita lakukan reload di sini.
    
    // TIPS: Edit file assets/js/pakar/kalkulator_pakar.js 
    // Cari bagian .then(data => { ... showNotification ... })
    // Tambahkan: setTimeout(() => location.reload(), 1500); di sana.
};
</script>
