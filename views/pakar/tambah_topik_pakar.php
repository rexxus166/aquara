    ...
    if (empty($judul) || empty($deskripsi)) {
        ...
        if (empty($message)) {
            ...
            if ($stmt->execute()) {
                ...
                echo "<script>alert('Topik berhasil dibuat!'); window.location.href='index_pakar.php?page=forum_pakar';</script>";
                exit;
            } else {
...
<main class="form-container">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div style="display: flex; gap: 10px; margin-top: 30px;">
            <a href="index_pakar.php?page=forum_pakar" style="padding: 15px 30px; background: #eee; color: #555; text-decoration: none; border-radius: 10px; font-weight: 600;">Batal</a>
