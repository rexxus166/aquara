...
<style>
  .user-profile {
    position: relative; /* Diperlukan agar dropdown menu pas */
    cursor: pointer;   /* Menunjukkan bisa di-klik */
  }
  
  .user-profile .dropdown-menu {
    display: none; /* Sembunyi secara default */
    position: absolute;
    top: 100%; /* Muncul di bawah profil */
    right: 0;
    background-color: white;
    border: 1px solid #ddd;
    border-radius: 4px;
    box-shadow: 0 4px 8px rgba(0,0,0,0.1);
    width: 150px; /* Atur lebar dropdown */
    z-index: 1000;
  }
